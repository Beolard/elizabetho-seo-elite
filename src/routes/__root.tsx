...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Elizabetho is a results-driven SEO specialist and digital growth consultant helping brands rank on Google, build authority, and convert more clients in 2026." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@bayewuelizabeth" },
      { name: "twitter:title", content: "Elizabetho — SEO Specialist & Digital Growth Consultant" },
      { name: "twitter:description", content: "Elizabetho is a results-driven SEO specialist and digital growth consultant helping brands rank on Google, build authority, and convert more clients in 2026." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/80572226-b4b8-4825-83ba-65f4a6f8808a/id-preview-a4a35ade--7668aeba-ab35-41de-bc86-87d1ae0b336a.lovable.app-1780139770274.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/80572226-b4b8-4825-83ba-65f4a6f8808a/id-preview-a4a35ade--7668aeba-ab35-41de-bc86-87d1ae0b336a.lovable.app-1780139770274.png" },
    ],
    links: [
